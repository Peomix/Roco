package com.QQ.angel.ui.core
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="com.QQ.angel.ui.core.NumericPanel")]
   public class NumericPanel extends Window implements IManagedWin
   {
      ...
      {
         this.props = ["expVal","money","honor","power","charm","intellect"];
         this.propsName = ["学 分","洛克贝","声 望","体 能","魅 力","智 慧"];
         super();
         this.initUIS();
      ...
      protected function setNumericData() : Boolean
      {
         ...
         while(_loc2_ < 3 && this.currIndex < this.props.length)
         {
            ...
            if((_loc4_ = this.data == null ? -1 : int(this.data[_loc3_])) != -1)
            {
