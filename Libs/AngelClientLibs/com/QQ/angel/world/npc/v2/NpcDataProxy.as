   ...
   public class NpcDataProxy extends EventDispatcher implements INpcDataProxy
   {
      ...
      protected function checkIconType() : int
      {
         ...
         while(_loc2_ < this.careStates.length)
         {
            ...
            if(_loc3_ != null)
            {
               if((_loc4_ = _loc3_.state) == TaskState.NOTACCEPTED || _loc4_ == TaskState.ACCEPTED)
               {
                  _loc1_ = _loc4_;
      ...
      protected function bindViewEvents(param1:Boolean = true) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(this.viewEvents != null)
            {
               ...
               {
                  if((_loc4_ = this.viewEvents[_loc3_]) != null && _loc4_.clickDes != null)
                  {
                     if(param1)
                     {
      ...
      protected function bindNpcFunc(param1:Boolean = true) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               {
                  if((_loc5_ = _loc3_[_loc4_]) != null && _loc5_.clickDes != null)
                  {
                     if(param1)
                     {
      ...
      public function removeCareTaskState(param1:TaskState, param2:Boolean = false) : void
      {
         ...
         var _loc3_:int = this.careStates.indexOf(param1);
         if(_loc3_ == -1)
         {
            return;
         }
         ...
         {
            _loc4_ = param1.id;
            _loc3_ = this.taskIDs.indexOf(_loc4_);
            if(_loc3_ != -1)
            {
      ...
      public function removeNpcFunc(param1:NpcFuncDes) : void
      {
         ...
         var _loc2_:int = this.npcFuncs.indexOf(param1);
         if(_loc2_ != -1)
         {
