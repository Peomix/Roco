package com.QQ.angel.world.role
{
   ...
   public class AngelRoleManager extends TickManager implements IRoleManager
   {
      ...
      public function set dataProxy(param1:IDataProxy) : void
      {
         ...
         (_loc4_ = __global.GEventAPI.angelEventDispatcher).addEventListener(AngelSysEvent.ON_SYS_EVENT,this.onSysEvent);
      }
      ...
      private function dispatchVipEvent(param1:Object) : void
      {
         ...
         var _loc4_:SysEventDes;
         (_loc4_ = new SysEventDes()).type = SysEventDes.VIP_LEVEL_CHANGE;
         _loc4_.data = param1;
         _loc3_.data = _loc4_;
