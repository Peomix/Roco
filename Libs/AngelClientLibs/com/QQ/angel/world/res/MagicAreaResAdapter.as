package com.QQ.angel.world.res
{
   ...
   public class MagicAreaResAdapter extends BaseAvatarResAdapter
   {
      ...
      override protected function onAvatarLoaded(param1:LoadTaskEvent, param2:Boolean = false) : void
      {
         ...
         (_loc10_ = new BitmapData(2 * MAGIC_WIDTH,2 * MAGIC_HEIGHT)).copyPixels(_loc9_,new Rectangle(0,0,2 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
         var _loc11_:BitmapData;
         (_loc11_ = new BitmapData(4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT)).copyPixels(_loc9_,new Rectangle(2 * MAGIC_WIDTH,0,4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
         var _loc12_:BitmapData;
         (_loc12_ = new BitmapData(4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT)).copyPixels(_loc9_,new Rectangle(6 * MAGIC_WIDTH,0,4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
         ...
         (_loc14_ = new BitmapData(2 * MAGIC_WIDTH,2 * MAGIC_HEIGHT)).copyPixels(_loc13_,new Rectangle(0,0,2 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
         var _loc15_:BitmapData;
         (_loc15_ = new BitmapData(4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT)).copyPixels(_loc13_,new Rectangle(2 * MAGIC_WIDTH,0,4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
         var _loc16_:BitmapData;
         (_loc16_ = new BitmapData(4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT)).copyPixels(_loc13_,new Rectangle(6 * MAGIC_WIDTH,0,4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
         pools.addNewTypeAvatar(_loc3_,_loc5_,2,param2,[_loc14_,_loc15_,_loc16_]);
         var _loc17_:Avatar;
         (_loc17_ = new Avatar()).styleID = _loc5_;
