package com.QQ.angel.world.res
{
   ...
   public class AvatarCacheItem extends EventDispatcher
   {
      ...
      protected var avatarAssets_WH:Array;
      
      protected var dazzleAssets_WH:Array;
      ...
      {
         this.avatarAssets_WH = defMotionDBs_WH;
         this.dazzleAssets_WH = defMotionDazzleDBs_WH;
         super();
         this.styleID = param1;
         this.version = param2;
      ...
      protected function onCacheTimer(param1:TimerEvent) : void
      {
         ...
         if(this.counts > 0)
         {
            ...
            {
               if((_loc5_ = this.motionAvatars[_loc4_]) != null && _loc5_.useCounts == 0)
               {
      ...
      protected function disposeAvatar(param1:Avatar) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc5_ = int((_loc4_ = param1.frames[_loc3_]).length);
            _loc6_ = 0;
            while(_loc6_ < _loc5_)
            {
               (_loc7_ = _loc4_[_loc6_] as BDFrame).img.dispose();
               _loc7_.img = null;
               _loc4_[_loc6_] = null;
               _loc6_++;
            }
      ...
      protected function createAvatar(param1:int, param2:Boolean) : Avatar
      {
         ...
         var _loc4_:Avatar;
         (_loc4_ = AvatarAssetProcess.processToAvatar(_loc3_,param1,this.mtFramesCounts,param2)).styleID = this.styleID;
