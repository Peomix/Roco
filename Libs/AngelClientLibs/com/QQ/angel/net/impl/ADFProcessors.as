package com.QQ.angel.net.impl
{
   ...
   public class ADFProcessors
   {
      ...
      public function decode(param1:ADF) : Object
      {
         ...
         var _loc4_:IDataProcessor;
         if((_loc4_ = this.maps[_loc2_] as IDataProcessor) == null || Boolean(this.freeProcs[_loc3_] as P_FreeRequest2))
         {
            ...
            {
               _loc6_ = _loc2_ + "_";
               if((_loc5_ = this.freeProcs[_loc6_]) != null)
               {
      ...
      public function encode(param1:Object, param2:int = -1, param3:uint = 0) : ADF
      {
         ...
         var _loc4_:IDataProcessor;
         if((_loc4_ = this.maps[param2] as IDataProcessor) == null || param1 is P_FreeRequest2)
         {
            if((_loc6_ = param1 as P_FreeRequest) != null)
            {
               if(param3 != 0)
               {
         ...
         var _loc5_:ADF;
         (_loc5_ = _loc4_.encode(param1,param2)).head.uiSerialNum = param3;
         return _loc5_;
      }
