package com.QQ.angel.net.ProtoNet
{
   ...
   public class NetManager
   {
      ...
      {
         var _loc5_:NetProcessor;
         (_loc5_ = new NetProcessor(param1,param2,param3)).onsuccess = param4;
         _loc5_.onerror = onerror;
         var _loc6_:P_FreeRequest;
         (_loc6_ = new P_FreeRequest(param1,_loc5_,_loc5_)).send(true);
      }
      ...
      private static function onGetDecodedData(param1:int, param2:Object, param3:Object, param4:Object) : int
      {
         ...
         var _loc7_:ADFHead;
         var _loc8_:int = int((_loc7_ = ADFHead(_loc5_[1])).cmdID);
         if(dataProcessorDic[_loc8_] != undefined || dataProcessorDic[_loc8_] != null)
         {
            ...
            {
               (_loc11_ = new ByteArray()).writeBytes(_loc6_);
               _loc11_.position = 0;
               (_loc13_ = new (_loc12_ = _loc9_[_loc10_].cl)()).readExternal(_loc11_);
               if(_loc13_)
               {
