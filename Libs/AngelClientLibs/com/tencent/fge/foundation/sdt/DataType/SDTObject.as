package com.tencent.fge.foundation.sdt.DataType
{
   ...
   public dynamic class SDTObject extends Proxy
   {
      ...
      {
         var _loc2_:String = param1;
         return Boolean(this.m_sdtValues) && this.m_sdtValues.hasOwnProperty(_loc2_) || Boolean(this.m_otherValues) && this.m_otherValues.hasOwnProperty(_loc2_);
      }
      
      override flash_proxy function deleteProperty(param1:*) : Boolean
      {
         var _loc2_:String = param1;
         if(Boolean(this.m_sdtValues) && this.m_sdtValues.hasOwnProperty(_loc2_))
         {
            this.deleteSdtProperty(_loc2_);
            return true;
         }
         if(Boolean(this.m_otherValues) && this.m_otherValues.hasOwnProperty(_loc2_))
         {
