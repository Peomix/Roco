   ...
   public class GIFDecoder
   {
      ...
      private function getPixels(param1:BitmapData) : Array
      {
         ...
         while(_loc7_ < _loc5_)
         {
            ...
            while(_loc8_ < _loc4_)
            {
               ...
               var _loc9_:*;
               _loc2_[_loc9_ = _loc3_++] = (_loc6_ & 16711680) >> 16;
               var _loc10_:*;
               _loc2_[_loc10_ = _loc3_++] = (_loc6_ & 65280) >> 8;
               var _loc11_:*;
               _loc2_[_loc11_ = _loc3_++] = _loc6_ & 255;
               _loc8_++;
            }
            _loc7_++;
         }
      ...
      private function transferPixels() : void
      {
         ...
         if(this.lastDispose > 0)
         {
            ...
            {
               _loc1_ = (_loc7_ = this.getPixels(this.lastImage)).slice();
         ...
         while(_loc5_ < this.ih)
         {
            ...
            if((_loc9_ += this.iy) < this.height)
            {
               _loc12_ = (_loc11_ = (_loc10_ = _loc9_ * this.width) + this.ix) + this.iw;
               ...
               {
                  _loc14_ = this.pixels[_loc13_++] & 255;
                  if((_loc15_ = int(this.act[_loc14_])) != 0)
                  {
         ...
         while(_loc13_ < _loc2_)
         {
            if(_loc17_ == 0)
            {
               if(_loc10_ < _loc6_)
               {
                  if(_loc12_ == 0)
                  {
                     if((_loc12_ = this.readBlock()) <= 0)
                     {
                        break;
                     }
                     _loc18_ = 0;
                  }
                  _loc14_ += (int(this.block[int(_loc18_)]) & 255) << _loc10_;
                  _loc10_ += 8;
                  _loc18_++;
                  _loc12_--;
                  continue;
               ...
               _loc16_ = this.suffix[int(_loc11_)] & 255;
      ...
      private function readColorTable(param1:int) : Array
      {
         ...
         else
         {
            ...
            while(_loc6_ < param1)
            {
               _loc8_ = _loc4_[_loc7_++] & 255;
               _loc9_ = _loc4_[_loc7_++] & 255;
               _loc10_ = _loc4_[_loc7_++] & 255;
               var _loc11_:*;
      ...
      private function readImage() : void
      {
         ...
         var _loc1_:int = this.readSingleByte();
         this.lctFlag = (_loc1_ & 128) != 0;
         this.interlace = (_loc1_ & 64) != 0;
      ...
      private function readNetscapeExt() : void
      {
         ...
         do
         {
            ...
            if(this.block[0] == 1)
            {
               _loc1_ = this.block[1] & 255;
               _loc2_ = this.block[2] & 255;
