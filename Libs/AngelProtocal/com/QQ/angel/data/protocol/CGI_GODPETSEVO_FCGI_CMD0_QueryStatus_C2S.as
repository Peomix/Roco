package com.QQ.angel.data.protocol
{
   ...
   public class CGI_GODPETSEVO_FCGI_CMD0_QueryStatus_C2S extends ProtocolBase implements I_C2S_CGI
   {
      
      public static const CGI_NAME:String = "god_pets_evo_fcgi?cmd=0";
       
      
      public function CGI_GODPETSEVO_FCGI_CMD0_QueryStatus_C2S()
      {
         super();
      }
