package com.QQ.angel.data.protocol
{
   ...
   public class SKT_0x110213_QueryQQSimpleInfoHome_S2C extends ProtocolBase implements I_S2C_Socket
   {
      ...
      public function SKT_0x110213_QueryQQSimpleInfoHome_S2C()
      {
         super();
      }
      ...
      public function readData(param1:IDataInput) : Boolean
      {
         ...
         {
            friendArray[_loc2_] = new QQSimpleInfoHome();
