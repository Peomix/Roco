package com.QQ.angel.data.protocol
{
   ...
   public class CGI_GARLICHALLOWMAS_CMD3_QueryStatus_C2S extends ProtocolBase implements I_C2S_CGI
   {
      
      public static const CGI_NAME:String = "garlic_hallowmas?cmd=3";
       
      
      public function CGI_GARLICHALLOWMAS_CMD3_QueryStatus_C2S()
      {
         super();
      }
