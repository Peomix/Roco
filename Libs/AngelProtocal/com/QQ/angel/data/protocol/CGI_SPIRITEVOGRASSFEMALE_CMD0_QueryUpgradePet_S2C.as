package com.QQ.angel.data.protocol
{
   ...
   public class CGI_SPIRITEVOGRASSFEMALE_CMD0_QueryUpgradePet_S2C extends ProtocolBase implements I_S2C_CGI
   {
      
      public static const CGI_NAME:String = "spirit_evo_grass_female?cmd=0";
      ...
      public function CGI_SPIRITEVOGRASSFEMALE_CMD0_QueryUpgradePet_S2C()
      {
         super();
      }
      ...
      public function decodeCGI(param1:XML) : Boolean
      {
         ...
         if(int(param1.result.@value) == 0)
         {
            ...
            {
               (_loc5_ = new PetInfo()).decodeCGI(_loc4_);
