package com.QQ.angel.data.protocol
{
   ...
   public class CGI_CRYSTALBLLAUGURY_CMD1_ApplyCharge_C2S extends ProtocolBase implements I_C2S_CGI
   {
      
      public static const CGI_NAME:String = "crystal_bll_augury?cmd=1";
       
      
      public function CGI_CRYSTALBLLAUGURY_CMD1_ApplyCharge_C2S()
      {
         super();
      }
