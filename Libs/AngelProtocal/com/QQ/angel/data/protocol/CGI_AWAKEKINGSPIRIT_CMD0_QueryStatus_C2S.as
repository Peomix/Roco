package com.QQ.angel.data.protocol
{
   ...
   public class CGI_AWAKEKINGSPIRIT_CMD0_QueryStatus_C2S extends ProtocolBase implements I_C2S_CGI
   {
      
      public static const CGI_NAME:String = "awake_king_spirit?cmd=0";
       
      
      public function CGI_AWAKEKINGSPIRIT_CMD0_QueryStatus_C2S()
      {
         super();
      }
