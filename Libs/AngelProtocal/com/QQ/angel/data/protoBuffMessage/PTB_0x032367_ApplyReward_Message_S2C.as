package com.QQ.angel.data.protoBuffMessage
{
   ...
   public final class PTB_0x032367_ApplyReward_Message_S2C extends Message implements IExternalizable
   {
      ...
      public function PTB_0x032367_ApplyReward_Message_S2C()
      {
         rewardArray = [];
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc7_ >>> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032367_ApplyReward_Message_S2C.retCode cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032367_ApplyReward_Message_S2C.status cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032367_ApplyReward_Message_S2C.time cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 5:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032367_ApplyReward_Message_S2C.step cannot be set twice.");
                  }
                  _loc6_++;
