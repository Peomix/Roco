package com.QQ.angel.data.protoBuffMessage
{
   ...
   public final class PTB_0x0322D6_ApplyCannon_Message_S2C extends Message implements IExternalizable
   {
      ...
      public function PTB_0x0322D6_ApplyCannon_Message_S2C()
      {
         evilState = [];
         evilHp = [];
         rewardArray = [];
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc10_ >>> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x0322D6_ApplyCannon_Message_S2C.retCode cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x0322D6_ApplyCannon_Message_S2C.state cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x0322D6_ApplyCannon_Message_S2C.countDown cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x0322D6_ApplyCannon_Message_S2C.hp cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 7:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x0322D6_ApplyCannon_Message_S2C.evilType cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 8:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x0322D6_ApplyCannon_Message_S2C.boxType cannot be set twice.");
                  }
                  _loc8_++;
               ...
               case 9:
                  if(_loc9_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x0322D6_ApplyCannon_Message_S2C.roundSucc cannot be set twice.");
                  }
                  _loc9_++;
