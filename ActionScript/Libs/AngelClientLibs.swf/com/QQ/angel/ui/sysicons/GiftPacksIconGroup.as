package com.QQ.angel.ui.sysicons
{
   ...
   public class GiftPacksIconGroup extends SysIconGroup implements ISceneListener
   {
      ...
      private function onSceneConfigLoaded(param1:int, param2:Object, param3:Object, param4:Object) : int
      {
         ...
         {
            _loc5_ = new XML(param2.npcXML);
            if(_loc5_.hasOwnProperty("SceneDes"))
            {
               if(Boolean(_loc5_.SceneDes[0].hasOwnProperty("@closeSubIcons")) && _loc5_.SceneDes[0].@closeSubIcons == "1")
               {
            ...
            else
            {
               ...
               while(_loc5_ < _loc1_)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        _loc2_.x = this.OneIconPos_X;
                        if(Boolean(_loc2_.hasOwnProperty("_isAlwaysShow")) && _loc2_["_isAlwaysShow"] == true)
                        {
                           _loc2_.x = this.Start_X - _loc4_ * this.Space_X;
                           _loc2_.visible = true;
                           _loc4_++;
      ...
      private function expandFunc(param1:Boolean) : void
      {
         ...
         else
         {
            ...
            {
               _loc4_ = _showIcons[_loc2_];
               if(!_loc4_.hasOwnProperty("_isAlwaysShow") || Boolean(_loc4_.hasOwnProperty("_isAlwaysShow")) && _loc4_["_isAlwaysShow"] == false)
               {
                  Tween.to(_loc4_,0.2,{
                     "x":0,
                     "alpha":0
