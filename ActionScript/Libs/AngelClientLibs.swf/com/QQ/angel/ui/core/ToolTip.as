package com.QQ.angel.ui.core
{
   ...
   public class ToolTip
   {
      ...
      protected function onShowTime(param1:TimerEvent) : void
      {
         ...
         {
            _loc6_ = _loc3_.split("||");
            _loc3_ = _loc6_[int(_loc6_.length * Math.random())];
         }
         ...
         if(Boolean(_loc2_.hasOwnProperty("tooltipPos")) && _loc2_["tooltipPos"] != null)
         {
         ...
         if(_loc5_)
         {
            _loc7_ = this.__bubble.x + this.__bubble.width - 960;
            if(_loc7_ > 0)
            {
