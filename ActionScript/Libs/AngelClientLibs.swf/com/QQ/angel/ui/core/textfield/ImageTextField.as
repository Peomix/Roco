package com.QQ.angel.ui.core.textfield
{
   ...
   public class ImageTextField extends Sprite
   {
      ...
      private function CaculatVipContent(param1:int, param2:String) : void
      {
         ...
         var _loc4_:Sprite = Reflection.createMovieClipInstance("VipIconUI") as Sprite;
         if(_loc4_ == null)
         {
            return;
         }
         var _loc5_:Rectangle = this._textField.getCharBoundaries(param1);
         if(_loc5_ != null)
         {
            _loc4_.x = _loc5_.x;
            _loc4_.y = _loc5_.y - 4;
      ...
      private function CaculatContent(param1:int, param2:String) : void
      {
         ...
         var _loc4_:Sprite = Reflection.createMovieClipInstance("Movie" + int(_loc3_)) as Sprite;
         if(_loc4_ == null)
         {
            return;
         }
