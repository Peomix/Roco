package com.QQ.angel.apps.utils
{
   ...
   public class CommFunction
   {
      ...
      {
         var _loc6_:OpenAsWinDes = new OpenAsWinDes();
         _loc6_.event = AngelSysEvent.ON_OPEN_ASWIN;
         _loc6_.src = param1;
         _loc6_.name = param2;
      ...
      public static function showItems(param1:Array) : void
      {
         ...
         while(_loc4_ < param1.length)
         {
            ...
            _loc6_ = _loc3_.select(_loc5_.id) as ItemDataDes;
            if(_loc6_ == null)
            {
      ...
      {
         var _loc4_:OpenCombatDes = new OpenCombatDes();
         _loc4_.combatType = 2;
