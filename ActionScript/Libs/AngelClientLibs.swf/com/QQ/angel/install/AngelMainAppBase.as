package com.QQ.angel.install
{
   ...
   public class AngelMainAppBase extends Sprite implements IAngelSysAPI, IGreenSystem
   {
      ...
      protected var serverInfo:ServerInfo = new ServerInfo();
      ...
      protected function initializeWorld(param1:Object, param2:Object, param3:Sprite) : void
      {
         ...
         _loc6_[Constants.CUR_SERVER_INFO] = this.getServerInfo(param1);
         ...
         var _loc7_:AngelAccessPermission = new AngelAccessPermission();
         _loc7_.setAngelSysAPI(this);
      ...
      protected function onLibLoaded(param1:Event = null) : void
      {
         ...
         var _loc5_:IEventDispatcher = this.gEventApi.angelEventDispatcher;
         _loc5_.addEventListener(AngelNetSysEvent.ON_STATE_CHANGE,this.onSystemNetClosed);
      }
