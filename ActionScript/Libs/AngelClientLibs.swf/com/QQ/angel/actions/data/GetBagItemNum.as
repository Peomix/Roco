package com.QQ.angel.actions.data
{
   ...
   public class GetBagItemNum extends AbstractDataReceiver
   {
      ...
      {
         super();
         var _loc4_:INetSysAPI = param1.getNetSysAPI();
         _loc4_.addDataReceiver(this);
         var _loc5_:P_ItemType = new P_ItemType();
         _loc5_.itemType = param3;
      ...
      override public function onDataReceive(param1:int, param2:Object) : void
      {
         ...
         {
            _loc3_ = int(this.delayItemIDs.pop());
