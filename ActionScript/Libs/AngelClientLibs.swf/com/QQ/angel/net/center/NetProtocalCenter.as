package com.QQ.angel.net.center
{
   ...
   public class NetProtocalCenter
   {
      ...
      private static function onApplySendDataTransById(param1:int, param2:Object, param3:Object, param4:Object) : int
      {
         ...
         {
            _loc6_ = getC2SProtocalClassByHash(_loc5_[0]);
            _loc7_ = new _loc6_();
            if(_loc5_.length >= 3)
            {
               _loc8_ = _loc5_[2];
      ...
      private static function onApplySendData(param1:int, param2:Object, param3:Object, param4:Object) : int
      {
         ...
         if((Boolean(_loc5_)) && Boolean(_loc5_[0]))
         {
            if(_loc5_[0] is I_C2S_Socket)
            {
               ...
               _loc6_ = new P_FreeRequest2(_loc7_.protocolHash,_loc7_,_loc7_,FreeRequestProxy.onReqReply);
               _loc6_.send(true);
               _loc6_ = null;
               _loc7_ = null;
            }
            else if(_loc5_[0] is I_C2S_ProtoBuf)
            {
               ...
               _loc6_ = new P_FreeRequest2(_loc8_.protocolHash,_loc8_,_loc8_,FreePBRequestProxy.onReqReply);
               _loc6_.send(true);
               _loc6_ = null;
               _loc8_ = null;
            }
            ...
            {
               _loc9_ = new FreeCGIRequestProxy(I_C2S_CGI(param2[0]),param2[0].getProtocolId(),param2[1] as Function);
               _loc9_.send();
               _loc9_ = null;
            }
         }
      ...
      public static function tryDecodeSocketData(param1:ByteArray, param2:ADFHead) : ProtocolBase
      {
         ...
         if(Boolean(param1) && Boolean(param2))
         {
            ...
            if(_loc3_ != null)
            {
               _loc4_ = new _loc3_() as ProtocolBase;
               if(_loc4_ is I_S2C_Socket)
               {
               ...
               {
                  _loc6_ = I_S2C_ProtoBuf(_loc4_).getS2CMessage();
                  _loc6_.readExternal(param1);
      ...
      private static function onGetRawData(param1:int, param2:Object, param3:Object, param4:Object) : int
      {
         ...
         if((Boolean(_loc5_)) && Boolean(_loc5_[0]))
         {
            ...
            if(_loc10_ != null)
            {
               _loc11_ = new _loc10_() as ProtocolBase;
               if(_loc11_ is I_S2C_Socket)
               {
                  _loc6_ = _loc5_[0] as ByteArray;
                  _loc6_.position = 0;
                  _loc12_ = Boolean(I_S2C_Socket(_loc11_).readData(_loc6_));
                  if(!_loc12_)
                  {
               ...
               else if(_loc11_ is I_S2C_ProtoBuf)
               {
                  _loc6_ = _loc5_[0] as ByteArray;
                  _loc6_.position = 0;
                  _loc13_ = I_S2C_ProtoBuf(_loc11_).getS2CMessage();
                  _loc13_.readExternal(_loc6_);
                  _loc12_ = Boolean(I_S2C_ProtoBuf(_loc11_).readProtoBuf(_loc13_));
                  if(!_loc12_)
                  {
               ...
               else if(_loc11_ is I_S2C_CGI)
               {
                  ...
                  _loc12_ = Boolean(I_S2C_CGI(_loc11_).decodeCGI(_loc7_));
                  if(!_loc12_)
                  {
