   ...
   public class ADFReceivers extends EventDispatcher
   {
      ...
      public function add(param1:IDataReceiver) : void
      {
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            _loc5_ = this.maps[_loc4_] as Array;
      ...
      public function remove(param1:IDataReceiver) : void
      {
         ...
         {
            _loc4_ = int(_loc2_[_loc3_]);
            _loc5_ = this.maps[_loc4_];
            if(_loc5_ == null)
            {
               return;
            }
            _loc6_ = int(_loc5_.indexOf(param1));
            if(_loc6_ != -1)
            {
      ...
      public function onDataReceive(param1:ADF) : void
      {
         ...
         if(_loc3_ != 0)
         {
            ...
            _loc6_ = this.currReqsMap[_loc5_];
            if(_loc6_ != null)
            {
         ...
         var _loc4_:Array = this.maps[_loc2_] as Array;
         if(_loc4_ != null)
         {
            _loc7_ = int(_loc4_.length - 1);
            while(_loc7_ >= 0)
            {
               _loc6_ = _loc4_[_loc7_] as IDataReceiver;
               if(_loc6_ != null)
               {
                  _loc6_.onDataReceive(_loc2_,param1.body);
               }
