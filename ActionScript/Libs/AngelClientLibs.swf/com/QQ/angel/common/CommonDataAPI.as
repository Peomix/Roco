package com.QQ.angel.common
{
   ...
   public class CommonDataAPI extends AbstractDataReceiver
   {
      ...
      public function checkHaveItem(param1:Object, param2:Array = null, param3:Function = null) : void
      {
         ...
         var _loc4_:P_FreeRequest = new P_FreeRequest(ADFCmdsType.T_QUERY,new P_Query(param2),P_Query,param3);
         _loc4_.send();
      }
      ...
      {
         var _loc4_:P_FreeRequest = new P_FreeRequest(ADFCmdsType.T_UPDATE_NPCVAL,new P_UpdateNpcVal(param1,param2),P_UpdateNpcVal,param3 != null ? param3 : this.__onNpcValUpdate);
         _loc4_.send();
