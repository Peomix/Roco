package com.QQ.angel.debug
{
   ...
   public class CmdBase
   {
      ...
      protected var m_lstCmdItemData:Array = new Array();
      ...
      protected function getExecuter(param1:Array) : Object
      {
         ...
         {
            _loc4_ = CmdMenuUtil.getCmdItemDataByParam(_loc2_,param1[_loc3_]);
            if(!_loc4_)
            {
               _loc4_ = CmdMenuUtil.getCmdItemDataByParam(_loc2_,"(-inputparameters)");
               if(_loc4_)
               {
                  return {
