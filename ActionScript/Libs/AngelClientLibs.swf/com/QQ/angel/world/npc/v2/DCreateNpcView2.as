package com.QQ.angel.world.npc.v2
{
   ...
   public class DCreateNpcView2 extends DCSpriteView implements INPCElementView, INPCTaskView, IAcceptMagicView, IAcceptMagicWithUin
   {
      ...
      public function setNPCVisible(param1:Boolean) : void
      {
         ...
         {
            if(Boolean(content.hasOwnProperty("delayHide")) && content["delayHide"] == true)
            {
               return;
            }
         }
      ...
      {
         if(content != null && Boolean(content.hasOwnProperty(param1)))
         {
            content[param1](true);
         }
      }
      ...
      {
         var _loc4_:IAcceptMagicView = content as IAcceptMagicView;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc5_:IAcceptMagicWithUin = content as IAcceptMagicWithUin;
         if(_loc5_ != null)
         {
