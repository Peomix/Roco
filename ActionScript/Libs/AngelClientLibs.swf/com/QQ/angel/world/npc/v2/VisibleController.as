package com.QQ.angel.world.npc.v2
{
   ...
   public class VisibleController
   {
      ...
      protected function refreshNpcs() : void
      {
         ...
         if(_loc1_ != null && _loc1_.length > 0)
         {
            ...
            while(_loc6_ < _loc1_.length)
            {
               ...
               _loc3_ = _loc4_.attachDes;
               _loc5_ = _loc4_.visibleXML.getTaskVisible(this.modelManager);
               if(_loc5_)
               {
      ...
      protected function refreshNpcFuncs() : void
      {
         ...
         var _loc6_:int = 0;
         var _loc5_:Array = this.npcModel.getVNpcFuncs();
         if(_loc5_ != null && _loc5_.length > 0)
         {
            ...
            while(_loc6_ < _loc5_.length)
            {
               ...
               if(_loc1_ != null)
               {
                  _loc4_ = _loc3_.visibleXML.getTaskVisible(this.modelManager);
                  if(_loc4_)
                  {
      ...
      public function refreshCareTaskIDs() : void
      {
         ...
         var _loc5_:Array = this.npcModel.getVCareStates();
         if(_loc5_ != null && _loc5_.length > 0)
         {
            _loc6_ = 0;
            while(_loc6_ < _loc5_.length)
            {
               ...
               if(_loc1_ != null)
               {
                  ...
                  _loc9_ = this.modelManager.getTaskModelByID(_loc8_.taskID);
                  if(_loc9_ != null)
                  {
