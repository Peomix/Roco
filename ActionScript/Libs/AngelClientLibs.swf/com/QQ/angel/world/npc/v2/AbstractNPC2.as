package com.QQ.angel.world.npc.v2
{
   ...
   public class AbstractNPC2 extends EventDispatcher implements INPCElement
   {
      ...
      protected function bindViewEvent(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            while(_loc4_ < _loc2_.length)
            {
               ...
               if(_loc5_ != null && _loc5_.handler != null)
               {
                  _loc6_ = _loc5_.eType;
      ...
      public function initialize(... rest) : void
      {
         ...
         var _loc4_:NpcViewDes = _loc2_.npcViewDes;
         if(_loc4_ != null)
         {
            this.view.setLocation(_loc2_.position);
            _loc6_ = this.view as IDCreateView;
            _loc6_.setPath(this.listener.getNpcPath(_loc2_.npcID,_loc4_.src));
         }
         this.bindViewEvent();
         var _loc5_:IEventDispatcher = this.view as IEventDispatcher;
         if(_loc5_ != null)
         {
