package com.QQ.angel.world.impl
{
   ...
   public class AngelWorld extends EventDispatcher implements IAngelWorld, IGreenSystem, IAngelSysAPIAware, ICmdListener
   {
      ...
      private static function onApplyChangeScene(param1:int, param2:Object, param3:Object, param4:Object) : int
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc5_.ver == 0)
            {
               ...
               _loc12_ = AllScenesConfig(_loc11_);
               if(_loc12_)
               {
      ...
      {
         var _loc5_:SceneDes = this.sceneManager.getCurrentScene();
         var _loc6_:int = _loc5_.sceneID;
         if(_loc6_ == param1 && _loc5_.uin == param2 && _loc5_.ver == param4)
         {
            return;
         }
         if(param1 == 0)
         ...
         var _loc7_:SceneDes = this.sceneConf.getScenesDesByID(param1,param4);
         if(_loc7_ == null)
         {
