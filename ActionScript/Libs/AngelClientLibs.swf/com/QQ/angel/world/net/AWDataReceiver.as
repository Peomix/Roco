package com.QQ.angel.world.net
{
   ...
   public class AWDataReceiver extends AbstractDataReceiver
   {
      ...
      {
         var _loc5_:AWDataReceiver = param4 as AWDataReceiver;
         _loc5_.globalEventDist.dispatchEvent(new AngelSysEvent(AngelSysEvent.ON_SCENEDATA_INIT));
      ...
      public function requestChangeScene(param1:int, param2:int, param3:uint, param4:int) : void
      {
         ...
         var _loc5_:P_ReqSceneChange = new P_ReqSceneChange();
         _loc5_.newSceneID = param2;
