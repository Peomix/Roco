package com.QQ.angel.world.res
{
   ...
   public class MagicAreaResAdapter extends BaseAvatarResAdapter
   {
      
      protected static var MAGIC_WIDTH:int = 200;
      
      protected static var MAGIC_HEIGHT:int = 200;
      
      public function MagicAreaResAdapter()
      {
         super();
         resType = Constants.MAGIC_AREA_RES;
      }
      ...
      override protected function onAvatarLoaded(param1:LoadTaskEvent, param2:Boolean = false) : void
      {
         ...
         var _loc9_:BitmapData = new _loc7_(10 * MAGIC_WIDTH,2 * MAGIC_HEIGHT) as BitmapData;
         var _loc10_:BitmapData = new BitmapData(2 * MAGIC_WIDTH,2 * MAGIC_HEIGHT);
         _loc10_.copyPixels(_loc9_,new Rectangle(0,0,2 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
         var _loc11_:BitmapData = new BitmapData(4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT);
         _loc11_.copyPixels(_loc9_,new Rectangle(2 * MAGIC_WIDTH,0,4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
         var _loc12_:BitmapData = new BitmapData(4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT);
         _loc12_.copyPixels(_loc9_,new Rectangle(6 * MAGIC_WIDTH,0,4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
         pools.addNewTypeAvatar(_loc3_,_loc5_,1,param2,[_loc10_,_loc11_,_loc12_]);
         var _loc13_:BitmapData = new _loc8_(10 * MAGIC_WIDTH,2 * MAGIC_HEIGHT) as BitmapData;
         var _loc14_:BitmapData = new BitmapData(2 * MAGIC_WIDTH,2 * MAGIC_HEIGHT);
         _loc14_.copyPixels(_loc13_,new Rectangle(0,0,2 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
         var _loc15_:BitmapData = new BitmapData(4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT);
         _loc15_.copyPixels(_loc13_,new Rectangle(2 * MAGIC_WIDTH,0,4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
         var _loc16_:BitmapData = new BitmapData(4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT);
         _loc16_.copyPixels(_loc13_,new Rectangle(6 * MAGIC_WIDTH,0,4 * MAGIC_WIDTH,2 * MAGIC_HEIGHT),new Point(0,0));
      ...
      {
         return DEFINE.DAZZLE_DRESS_RES_ROOT + "18/" + param1.avatarType + ".swf";
      }
   }
}
