package com.QQ.angel.external
{
   ...
   public class AngelExternalManger implements IExternalAPI, IAngelSysAPIAware, ICmdListener
   {
      ...
      {
         var _loc5_:OpenAsWinDes = new OpenAsWinDes();
         _loc5_.src = param2 as String;
      ...
      protected function onWCClosing(param1:WindowEvent) : void
      {
         ...
         {
            _loc5_ = _loc2_.getContent() as IAngelApp;
            if(_loc5_ != null)
            {
               _loc5_.inactivate();
            }
      ...
      protected function onWCLoaded(param1:LoadTaskEvent, param2:* = null) : void
      {
         ...
         if(_loc5_ != null)
         {
            ...
            _loc4_ = this.commUI.createScaleWinow(_loc5_,this.openAsWinParam == null ? false : Boolean(this.openAsWinParam.isModal));
            if(_loc4_ != null)
            {
               ...
               _loc6_ = this.openAsWinParam == null ? null : this.openAsWinParam.pos;
               if(_loc6_ != null)
               {
      ...
      {
         var _loc10_:OpenAsWinDes = new OpenAsWinDes();
         _loc10_.src = param1;
         _loc10_.name = param2;
      ...
      private function _openASWindow(param1:String, param2:String, param3:Boolean = false, param4:Point = null, param5:Function = null, param6:Object = null, param7:Boolean = true, param8:Boolean = false, param9:Object = null) : Boolean
      {
         ...
         if(param1 == "")
         {
            _loc11_ = ApplicationDomain.currentDomain;
            if(_loc11_.hasDefinition(param2))
            {
         ...
         var _loc10_:IWindow = this.asWinsCache[param1];
         if(_loc10_ != null)
         {
            this.openAsWinParam = null;
            _loc10_.show();
            _loc10_.bringToFront();
            _loc13_ = _loc10_.getContent();
            if(_loc13_ is IParamsAware)
            {
