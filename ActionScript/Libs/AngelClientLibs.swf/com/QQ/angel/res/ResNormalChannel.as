   ...
   public class ResNormalChannel extends EventDispatcher implements IResChannel
   {
      ...
      public function addTask(param1:ResLoadTask) : int
      {
         ...
         else
         {
            ...
            while(_loc6_ >= 0)
            {
               _loc4_ = this.calcTaskPriority(this._tasks[_loc6_]);
               if(_loc4_ >= _loc3_)
               {
      ...
      private function loadSubTask() : void
      {
         ...
         if(this._currentTask != null)
         {
            ...
            else if(_loc2_ != null && Boolean(_loc2_.hasOwnProperty("url")))
            {
      ...
      private function isNotCurrentURL() : Boolean
      {
         ...
         {
            _loc4_ = this._loader.content as Bitmap;
            if(_loc4_ != null && _loc4_.bitmapData != null)
            {
