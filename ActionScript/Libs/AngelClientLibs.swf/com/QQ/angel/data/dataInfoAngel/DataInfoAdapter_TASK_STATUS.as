   ...
   public class DataInfoAdapter_TASK_STATUS extends DataInfoAdapterSocketMonitor
   {
      ...
      override public function onDataGetted(param1:ProtocolBase) : void
      {
         ...
         else
         {
            ...
            for each(_loc6_ in _loc2_)
            {
               _loc5_ = TaskInfo(_loc4_[_loc6_.taskTaskId]);
               if(!_loc5_)
               {
                  _loc4_[_loc6_.taskTaskId] = _loc6_;
               }
            ...
            for each(_loc8_ in _loc4_)
            {
               ...
               _loc10_ = int(_loc8_.taskStoryId);
               if((Boolean(_loc10_)) && _loc7_.indexOf(_loc10_) == -1)
               {
                  _loc7_.push(_loc10_);
                  _loc11_ = this.m_storyDict[_loc10_];
                  if(_loc11_ != null)
                  {
                     _loc12_ = int(_loc11_.indexOf(_loc9_));
                     if(_loc12_ != -1)
                     {
                        if(_loc12_ > 0)
                        {
                           ...
                           while(_loc13_ < _loc12_)
                           {
                              ...
                              {
                                 _loc15_ = new TaskInfo();
                                 _loc15_.taskStatus = TaskState.DONE;
