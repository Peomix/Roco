package com.QQ.angel.data.dataInfoAngel
{
   ...
   public class DataInfoAdapter_TASK_CONDITION_STATUS extends DataInfoAdapterRequest
   {
      ...
      private static function onDataGettedFormMonitor(param1:ProtocolBase) : void
      {
         ...
         {
            _loc5_ = SKT_0x0C0001_QueryTaskConditionStatus_S2C(param1);
            _loc2_ = int(_loc5_.taskTaskId);
            if(_loc2_ == 0)
            {
            ...
            _loc4_ = DataInfoCenter.getInstance().getDataInfoPair(DataInfoType.DATAINFO_TYPE_TASK_CONDITION_STATUS,_loc2_);
            if(!_loc4_)
            {
