package com.tencent.protobuf
{
   ...
   public final class ReadUtils
   {
         ...
         if(_loc3_ >= 128)
         {
            ...
            while(true)
            {
               ...
               if(_loc4_ < 32)
               {
                  ...
                  _loc2_.high |= (_loc3_ & 0x7F) << _loc4_;
               }
               _loc4_ += 7;
            }
      ...
      {
         return read$TYPE_INT32(param1) != 0;
      }
      ...
      {
         return int(read$TYPE_FIXED32(param1));
      }
      
      public static function read$TYPE_SFIXED64(param1:IDataInput) : Int64
      {
         var _loc2_:Int64 = new Int64();
         var _loc3_:UInt64 = read$TYPE_FIXED64(param1);
         _loc2_.low = _loc3_.low;
         _loc2_.high = int(_loc3_.high);
         return _loc2_;
      }
      ...
      public static function read$TYPE_SINT64(param1:IDataInput) : Int64
      {
         ...
         var _loc4_:uint = uint(_loc2_.high);
         _loc2_.low = ZigZag.decode64low(_loc3_,_loc4_);
         _loc2_.high = ZigZag.decode64high(_loc3_,_loc4_);
         return _loc2_;
      }
      
      public static function read$TYPE_MESSAGE(param1:IDataInput, param2:IMessage) : IMessage
      {
         var _loc3_:uint = read$TYPE_UINT32(param1);
