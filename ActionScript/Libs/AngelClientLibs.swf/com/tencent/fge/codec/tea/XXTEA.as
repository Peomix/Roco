package com.tencent.fge.codec.tea
{
   public class XXTEA
   {
      ...
      public static function encrypt_CharArray(param1:Array, param2:Array) : Array
      {
         ...
         while(0 < _loc13_--)
         {
            _loc14_ = _loc14_ + _loc9_ & 0xFFFFFFFF;
            _loc11_ = _loc14_ >>> 2 & 3;
            _loc12_ = 0;
            while(_loc12_ < _loc6_)
            {
               ...
               _loc7_ = _loc3_[_loc12_] = _loc3_[_loc12_] + _loc10_ & 0xFFFFFFFF;
               _loc12_++;
            }
            _loc8_ = int(_loc3_[0]);
            _loc10_ = (_loc7_ >>> 5 ^ _loc8_ << 2) + (_loc8_ >>> 3 ^ _loc7_ << 4) ^ (_loc14_ ^ _loc8_) + (_loc5_[_loc12_ & 3 ^ _loc11_] ^ _loc7_);
            _loc7_ = _loc3_[_loc6_] = _loc3_[_loc6_] + _loc10_ & 0xFFFFFFFF;
         }
         ...
         while(_loc4_ < _loc15_)
         {
            ...
            _loc16_[_loc4_ * 4] = _loc17_ >> 24 & 0xFF;
            _loc16_[_loc4_ * 4 + 1] = _loc17_ >> 16 & 0xFF;
            _loc16_[_loc4_ * 4 + 2] = _loc17_ >> 8 & 0xFF;
            _loc16_[_loc4_ * 4 + 3] = _loc17_ & 0xFF;
            _loc4_++;
         }
         return _loc16_;
      }
      ...
      public static function decrypt_CharArray(param1:Array, param2:Array) : Array
      {
         ...
         var _loc15_:int = Math.floor(6 + 52 / (_loc8_ + 1));
         var _loc16_:* = _loc15_ * _loc11_ & 0xFFFFFFFF;
         while(_loc16_ != 0)
         {
            _loc13_ = _loc16_ >>> 2 & 3;
            _loc14_ = _loc8_;
            while(_loc14_ > 0)
            {
               _loc9_ = int(_loc4_[_loc14_ - 1]);
               _loc12_ = (_loc9_ >>> 5 ^ _loc10_ << 2) + (_loc10_ >>> 3 ^ _loc9_ << 4) ^ (_loc16_ ^ _loc10_) + (_loc7_[_loc14_ & 3 ^ _loc13_] ^ _loc9_);
               _loc10_ = _loc4_[_loc14_] = _loc4_[_loc14_] - _loc12_ & 0xFFFFFFFF;
               _loc14_--;
            }
            _loc9_ = int(_loc4_[_loc8_]);
            _loc12_ = (_loc9_ >>> 5 ^ _loc10_ << 2) + (_loc10_ >>> 3 ^ _loc9_ << 4) ^ (_loc16_ ^ _loc10_) + (_loc7_[_loc14_ & 3 ^ _loc13_] ^ _loc9_);
            _loc10_ = _loc4_[0] = _loc4_[0] - _loc12_ & 0xFFFFFFFF;
            _loc16_ = _loc16_ - _loc11_ & 0xFFFFFFFF;
         }
