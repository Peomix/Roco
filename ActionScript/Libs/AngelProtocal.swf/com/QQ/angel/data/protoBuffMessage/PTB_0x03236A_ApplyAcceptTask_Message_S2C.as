         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc6_ >>> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x03236A_ApplyAcceptTask_Message_S2C.retCode cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x03236A_ApplyAcceptTask_Message_S2C.userStatus cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x03236A_ApplyAcceptTask_Message_S2C.questionId cannot be set twice.");
                  }
                  _loc5_++;
