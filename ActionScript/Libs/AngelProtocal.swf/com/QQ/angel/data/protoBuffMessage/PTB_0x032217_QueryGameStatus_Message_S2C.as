package com.QQ.angel.data.protoBuffMessage
{
   ...
   public final class PTB_0x032217_QueryGameStatus_Message_S2C extends Message implements IExternalizable
   {
      ...
      public function PTB_0x032217_QueryGameStatus_Message_S2C()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc7_ >>> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032217_QueryGameStatus_Message_S2C.npcExist cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032217_QueryGameStatus_Message_S2C.npcHP0 cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032217_QueryGameStatus_Message_S2C.npcHP1 cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032217_QueryGameStatus_Message_S2C.chestLeftTime cannot be set twice.");
                  }
                  _loc6_++;
