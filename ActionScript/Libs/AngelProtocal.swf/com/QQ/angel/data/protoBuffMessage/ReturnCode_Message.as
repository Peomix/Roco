package com.QQ.angel.data.protoBuffMessage
{
   ...
   public final class ReturnCode_Message extends Message implements IExternalizable
   {
      ...
      public function ReturnCode_Message()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc5_ >>> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: ReturnCode_Message.code cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: ReturnCode_Message.message cannot be set twice.");
                  }
                  _loc4_++;
                  message = ReadUtils.read$TYPE_STRING(param1);
                  break;
               default:
