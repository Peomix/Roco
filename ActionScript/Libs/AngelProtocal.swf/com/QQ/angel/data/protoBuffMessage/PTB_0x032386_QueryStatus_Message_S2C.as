package com.QQ.angel.data.protoBuffMessage
{
   ...
   public final class PTB_0x032386_QueryStatus_Message_S2C extends Message implements IExternalizable
   {
      ...
      public function PTB_0x032386_QueryStatus_Message_S2C()
      {
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc13_ >>> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032386_QueryStatus_Message_S2C.retCode cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032386_QueryStatus_Message_S2C.hasGetSpirit cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032386_QueryStatus_Message_S2C.catchSpiritId cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032386_QueryStatus_Message_S2C.hasCatchSpirit cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032386_QueryStatus_Message_S2C.hasAccptedCatchSpirit cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 6:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032386_QueryStatus_Message_S2C.hasAccptedRepairBook cannot be set twice.");
                  }
                  _loc8_++;
               ...
               case 7:
                  if(_loc9_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032386_QueryStatus_Message_S2C.hasKingTrust cannot be set twice.");
                  }
                  _loc9_++;
               ...
               case 8:
                  if(_loc10_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032386_QueryStatus_Message_S2C.hasDeanTrust cannot be set twice.");
                  }
                  _loc10_++;
               ...
               case 9:
                  if(_loc11_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032386_QueryStatus_Message_S2C.deanItemNum cannot be set twice.");
                  }
                  _loc11_++;
               ...
               case 10:
                  if(_loc12_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032386_QueryStatus_Message_S2C.kingItemNum cannot be set twice.");
                  }
                  _loc12_++;
