package com.QQ.angel.data.protocol
{
   ...
   public class CGI_BREAKICE_CMD1_ApplyGameEnd_S2C extends ProtocolBase implements I_S2C_CGI
   {
      
      public static const CGI_NAME:String = "break_ice?cmd=1";
      ...
      public var processAdd:uint;
      
      public var mailbox:uint;
      
      public function CGI_BREAKICE_CMD1_ApplyGameEnd_S2C()
      {
         super();
      }
      ...
      public function decodeCGI(param1:XML) : Boolean
      {
         ...
         if(int(param1.result.@value) == 0)
         {
            ...
            processAdd = uint(param1.processAdd.text());
