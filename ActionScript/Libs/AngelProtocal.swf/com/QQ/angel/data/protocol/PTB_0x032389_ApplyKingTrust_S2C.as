...
{
   import com.QQ.angel.data.protoBuffMessage.PTB_0x032389_ApplyKingTrust_Message_S2C;
   ...
   public class PTB_0x032389_ApplyKingTrust_S2C extends ProtocolBase implements I_S2C_ProtoBuf
   {
      
      public static const PROTOCOL_ID:int = 205705;
      ...
      public function PTB_0x032389_ApplyKingTrust_S2C()
      {
         super();
      }
      ...
      {
         var _loc2_:PTB_0x032389_ApplyKingTrust_Message_S2C = PTB_0x032389_ApplyKingTrust_Message_S2C(param1);
      ...
      {
         return new PTB_0x032389_ApplyKingTrust_Message_S2C();
      }
   }
}
