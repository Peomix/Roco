package com.QQ.angel.data.protocol
{
   ...
   public class CGI_PRAYFORRAINING_CMD0_QueryStatus_S2C extends ProtocolBase implements I_S2C_CGI
   {
      
      public static const CGI_NAME:String = "pray_for_raining?cmd=0";
      
      public var bubble_left_time:uint;
      ...
      public var bubble_hit_count:uint;
      
      public var can_not_hit_flag:uint;
      
      public var bubble_reward_type:uint;
      
      public var pray_rain_count:uint;
      
      public function CGI_PRAYFORRAINING_CMD0_QueryStatus_S2C()
      {
         super();
      }
      ...
      public function decodeCGI(param1:XML) : Boolean
      {
         ...
         if(int(param1.result.@value) == 0)
         {
            ...
            bubble_left_time = uint(param1.bubble_left_time.text());
            bubble_hit_count = uint(param1.bubble_hit_count.text());
            bubble_reward_type = uint(param1.bubble_reward_type.text());
            can_not_hit_flag = uint(param1.can_not_hit_flag.text());
            uin = uint(param1.uin.text());
            return true;
         }
         retCode = new P_ReturnCode();
         retCode.code = int(param1.result.@value);
