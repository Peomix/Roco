...
{
   import com.QQ.angel.data.protoBuffMessage.PTB_0x03236C_ApplyReward_Message_S2C;
   ...
   public class PTB_0x03236C_ApplyReward_S2C extends ProtocolBase implements I_S2C_ProtoBuf
   {
      
      public static const PROTOCOL_ID:int = 205676;
      
      public var hasPlayCount:uint;
      
      public var rewardArray:Array;
      
      public var sendMailFlag:uint;
      
      public var retCode:P_ReturnCode;
      
      public var maxPlayCount:uint;
      
      public function PTB_0x03236C_ApplyReward_S2C()
      {
         super();
      }
      ...
      {
         var _loc2_:PTB_0x03236C_ApplyReward_Message_S2C = PTB_0x03236C_ApplyReward_Message_S2C(param1);
         ...
         sendMailFlag = _loc2_.sendMailFlag;
         if(!rewardArray)
         {
      ...
      {
         return new PTB_0x03236C_ApplyReward_Message_S2C();
      }
   }
}
