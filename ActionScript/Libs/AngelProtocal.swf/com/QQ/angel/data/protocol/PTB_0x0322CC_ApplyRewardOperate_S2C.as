...
{
   import com.QQ.angel.data.protoBuffMessage.PTB_0x0322CC_ApplyRewardOperate_Message_S2C;
   ...
   public class PTB_0x0322CC_ApplyRewardOperate_S2C extends ProtocolBase implements I_S2C_ProtoBuf
   {
      ...
      public function PTB_0x0322CC_ApplyRewardOperate_S2C()
      {
         super();
      }
      ...
      {
         var _loc2_:PTB_0x0322CC_ApplyRewardOperate_Message_S2C = PTB_0x0322CC_ApplyRewardOperate_Message_S2C(param1);
      ...
      {
         return new PTB_0x0322CC_ApplyRewardOperate_Message_S2C();
      }
   }
}
