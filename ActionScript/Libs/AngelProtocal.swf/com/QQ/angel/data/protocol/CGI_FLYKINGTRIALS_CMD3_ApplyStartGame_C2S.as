package com.QQ.angel.data.protocol
{
   ...
   public class CGI_FLYKINGTRIALS_CMD3_ApplyStartGame_C2S extends ProtocolBase implements I_C2S_CGI
   {
      
      public static const CGI_NAME:String = "fly_king_trials?cmd=3";
      
      public function CGI_FLYKINGTRIALS_CMD3_ApplyStartGame_C2S()
      {
         super();
      }
