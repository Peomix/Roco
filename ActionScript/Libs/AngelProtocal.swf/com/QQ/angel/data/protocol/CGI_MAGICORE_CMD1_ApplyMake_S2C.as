package com.QQ.angel.data.protocol
{
   ...
   public class CGI_MAGICORE_CMD1_ApplyMake_S2C extends ProtocolBase implements I_S2C_CGI
   {
      
      public static const CGI_NAME:String = "magic_ore?cmd=1";
      ...
      public function CGI_MAGICORE_CMD1_ApplyMake_S2C()
      {
         super();
      }
      ...
      public function decodeCGI(param1:XML) : Boolean
      {
         ...
         if(int(param1.result.@value) == 0)
         {
            ...
            {
               _loc4_ = new ItemInfoChanged32();
               _loc4_.decodeCGI(_loc2_);
               item.push(_loc4_);
            }
            if(!rewardArray)
            {
