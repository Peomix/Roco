package com.QQ.angel.data.protocol
{
   ...
   public class CGI_HARVESTMOON_CMD6_QueryItemStatus_C2S extends ProtocolBase implements I_C2S_CGI
   {
      
      public static const CGI_NAME:String = "harvest_moon?cmd=6";
      
      public function CGI_HARVESTMOON_CMD6_QueryItemStatus_C2S()
      {
         super();
      }
