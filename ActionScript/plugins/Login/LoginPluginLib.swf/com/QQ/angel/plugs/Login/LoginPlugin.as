package com.QQ.angel.plugs.Login
{
   ...
   public class LoginPlugin extends Sprite implements IPlugProgram
   {
      ...
      private var platfromSrcProcessor:PlatfromSrcProcessor = new PlatfromSrcProcessor();
      ...
      private var loginProcessor:LoginDataProcessor = new LoginDataProcessor();
      
      private var system:IAngelSysAPI;
      
      private var recommendProcessor:RecommendDataProcessor = new RecommendDataProcessor();
      ...
      private var svrNameEngine:SvrNameEngine = new SvrNameEngine();
      ...
      private var initalProcessor:InitialComponentDataProcessor = new InitialComponentDataProcessor();
      
      private var roomLoginConn:ITCPProxy;
      
      private var ageRule:UIAgeRule;
      
      private var fastLoginProcessor:FastLoginDataProcessor = new FastLoginDataProcessor();
      ...
      private var rangeProcessor:RangeDataProcessor = new RangeDataProcessor();
      ...
      {
         var _loc5_:LoginPlugin = LoginPlugin(param4);
         if(Boolean(_loc5_.plugins) && _loc5_.plugins.indexOf(String(param2[2])) != -1)
         {
            ++_loc5_.count;
      ...
      private function onTCPConnect(param1:TCPConnEvent) : void
      {
         ...
         var _loc2_:int = param1.getTCPID();
         ...
         switch(param1)
         {
            case ADFCmdsType.T_LoginRoom:
               ...
               else
               {
                  ...
                  _loc6_ = new SceneDes();
                  _loc6_.sceneID = _loc5_.sceneID;
                  _loc6_.ver = _loc5_.sceneVer;
                  globalData.addGlobalVal(Constants.WANT_TO_SCENE,_loc6_);
                  _loc7_ = new AngelSysEvent(AngelSysEvent.LOGIN_OK);
                  _loc7_.data = getPlugName();
            ...
            case ADFCmdsType.T_DIR_RANGE_REPLY:
               ...
               if(Boolean(rangeData) && !rangeData.returnCode.isError())
               {
                  ...
                  {
                     _loc8_ = rangeData.roomInfos[0] as RoomData;
                     if(_loc8_.roomStat == 0)
                     {
