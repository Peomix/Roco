package com.QQ.angel.net.processor
{
   ...
   public class RoleDetailProcessor extends EventDispatcher implements IDataProcessor
   {
      ...
      public function decode(param1:ADF) : Object
      {
         ...
         var _loc4_:RoleDetailData = new RoleDetailData();
         ...
         var _loc8_:Object = __global.SysAPI.getGDataAPI().getDataProxy(Constants.ACHIEVE_LIST_DATA).select(_loc4_.achieveId,_loc4_.titleLevel);
         if(_loc8_)
         {
      ...
      public function encode(param1:Object, param2:int = -1) : ADF
      {
         ...
         var _loc4_:P_UInt = new P_UInt();
         _loc4_.num = param1 as uint;
         _loc3_.body = _loc4_;
         return _loc3_;
      }
