package BitmapFont.font.v9
{
   ...
   public class TextFieldBitmap extends Shape implements IDispose
   {
      ...
      public function set defaultTextFormat(param1:TextFormat) : void
      {
         ...
         _loc2_.redMultiplier = (_loc3_ >> 16 & 0xFF) / 255;
         _loc2_.greenMultiplier = (_loc3_ >> 8 & 0xFF) / 255;
         _loc2_.blueMultiplier = (_loc3_ & 0xFF) / 255;
      ...
      public function render() : void
      {
         ...
         if(this.background)
         {
            _loc1_.beginFill(this.backgroundColor & 0xFFFFFF,(this.backgroundColor >> 24 & 0xFF) / 255);
         }
         if(this.border)
         {
            _loc1_.lineStyle(0,this.borderColor & 0xFFFFFF,(this.borderColor >> 24 & 0xFF) / 255);
         }
