package com.QQ.angel.data.protoBuffMessage
{
   ...
   public final class PTB_0x032132_ApplyLotteryReward_Message_S2C extends Message implements IExternalizable
   {
      ...
      public function PTB_0x032132_ApplyLotteryReward_Message_S2C()
      {
         rewardArray = [];
         super();
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc4_ >>> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032132_ApplyLotteryReward_Message_S2C.retCode cannot be set twice.");
                  }
                  _loc3_++;
