package com.QQ.angel.data.protoBuffMessage
{
   ...
   public final class PTB_0x032314_CMD1_ApplyPutEgg_Message_S2C extends Message implements IExternalizable
   {
      ...
      private var egg$field:uint;
      
      private var status_vip$field:uint;
      
      private var cd$field:uint;
      
      public function PTB_0x032314_CMD1_ApplyPutEgg_Message_S2C()
      {
         super();
      }
      
      public function set egg(param1:uint) : void
      {
         hasField$0 |= 16;
         egg$field = param1;
      }
      ...
      public function get hasEgg() : Boolean
      {
         return (hasField$0 & 16) != 0;
      }
      
      public function get egg() : uint
      {
         if(!hasEgg)
         {
            return 0;
      ...
      final override public function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         if(hasEgg)
         {
            ...
            WriteUtils.write$TYPE_UINT32(param1,egg$field);
         }
      }
         ...
         while(param1.bytesAvailable > param2)
         {
            ...
            switch(_loc9_ >>> 3)
            {
               case 1:
                  if(_loc3_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032314_CMD1_ApplyPutEgg_Message_S2C.retCode cannot be set twice.");
                  }
                  _loc3_++;
               ...
               case 2:
                  if(_loc4_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032314_CMD1_ApplyPutEgg_Message_S2C.status cannot be set twice.");
                  }
                  _loc4_++;
               ...
               case 3:
                  if(_loc5_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032314_CMD1_ApplyPutEgg_Message_S2C.statusVip cannot be set twice.");
                  }
                  _loc5_++;
               ...
               case 4:
                  if(_loc6_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032314_CMD1_ApplyPutEgg_Message_S2C.cd cannot be set twice.");
                  }
                  _loc6_++;
               ...
               case 5:
                  if(_loc7_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032314_CMD1_ApplyPutEgg_Message_S2C.cdVip cannot be set twice.");
                  }
                  _loc7_++;
               ...
               case 6:
                  if(_loc8_ != 0)
                  {
                     throw new IOError("Bad data format: PTB_0x032314_CMD1_ApplyPutEgg_Message_S2C.egg cannot be set twice.");
                  }
                  _loc8_++;
                  egg = ReadUtils.read$TYPE_UINT32(param1);
                  break;
               default:
