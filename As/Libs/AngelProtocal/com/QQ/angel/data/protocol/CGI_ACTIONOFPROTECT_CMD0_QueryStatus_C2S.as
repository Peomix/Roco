package com.QQ.angel.data.protocol
{
   ...
   public class CGI_ACTIONOFPROTECT_CMD0_QueryStatus_C2S extends ProtocolBase implements I_C2S_CGI
   {
      
      public static const CGI_NAME:String = "action_of_protect?cmd=0";
       
      
      public function CGI_ACTIONOFPROTECT_CMD0_QueryStatus_C2S()
      {
         super();
      }
