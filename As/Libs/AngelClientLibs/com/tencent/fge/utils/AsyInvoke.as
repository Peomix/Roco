package com.tencent.fge.utils
{
   ...
   public class AsyInvoke extends Invoke
   {
      ...
      {
         var _loc4_:AsyInvoke;
         (_loc4_ = new AsyInvoke(param1,null)).arg = rest;
      ...
      public static function kill(param1:Function, param2:Boolean = false) : void
      {
         ...
         {
            if((Boolean(_loc6_ = s_lstInvoker[_loc3_])) && _loc6_.fun == param1)
            {
               _loc4_.push(_loc6_);
            }
            _loc3_++;
      ...
      override public function release() : void
      {
         ...
         var _loc1_:int = s_lstInvoker.indexOf(this);
         if(0 <= _loc1_)
         {
