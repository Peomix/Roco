package com.QQ.angel.plug
{
   ...
   public class AngelPlugManager implements IAngelPluginManager, IAngelSysAPIAware, ICmdListener
   {
      ...
      private static function onInstallOrCallPlugin(param1:int, param2:Object, param3:Object, param4:Object) : int
      {
         ...
         var _loc6_:AngelPlugManager;
         if((Boolean(_loc6_ = AngelPlugManager(param4))) && Boolean(_loc5_))
         {
            if(_loc5_[0])
            {
      ...
      {
         var _loc5_:IPlugProgram;
         if(_loc5_ = this.getPlugByName("com.QQ.angel.plugs." + param1 + "::" + param1 + "Plugin"))
         {
            _loc5_.call(param2);
            return;
         }
         ...
         var _loc7_:CmdExeDes;
         (_loc7_ = new CmdExeDes()).cmdType = param1;
         _loc7_.arg = param2;
         _loc6_.data = _loc7_;
      ...
      {
         var _loc5_:PluginSetting;
         if((_loc5_ = this.getSettingByName(param2)) == null)
         {
            (_loc5_ = new PluginSetting()).plugSrc = param1;
