package com.QQ.angel.data.npc
{
   ...
   public class NpcDialogCenter
   {
      ...
      public function mergeData(param1:OpenNPCTaskDes, param2:SceneDes) : NPCDialogData
      {
         ...
         var _loc4_:NPCDialogData;
         if((_loc4_ = this.getNPCDialogDataByHash(_loc3_)).dialogs.length == 0)
         {
            _loc4_.dialogs.push(new NpcDialogDataContent());
         }
         var _loc5_:NpcDialogDataContent;
         (_loc5_ = NpcDialogDataContent(_loc4_.dialogs[0])).npcURL = __global.getNPCPreview(param1.npcID);
         _loc5_.npcName = param1.npcname;
         _loc5_.text = param1.dialog;
         _loc6_ = 0;
         while(_loc6_ < _loc4_.items.length)
         {
            if((_loc7_ = NpcDialogDataItem(_loc4_.items[_loc6_])).isFromXml)
            {
         ...
         var _loc8_:Array;
         if((_loc8_ = param1.npcFuns) != null && _loc8_.length > 0)
         {
            _loc11_ = [];
            _loc6_ = 0;
            while(_loc6_ < _loc8_.length)
            {
               ...
               (_loc7_ = new NpcDialogDataItem()).label = _loc12_.label;
         ...
         {
            if((_loc9_ = NpcDialogDataButton(_loc4_.buttons[_loc6_])).isFromXml)
            {
         ...
         (_loc9_ = new NpcDialogDataButton()).label = "离开";
         _loc9_.close = true;
         _loc9_.isFromXml = true;
         _loc4_.buttons.push(_loc9_);
         var _loc10_:NPCDialogData;
         (_loc10_ = new NPCDialogData()).dialogs = _loc4_.dialogs.slice();
