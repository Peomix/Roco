package com.QQ.angel.debug.menu
{
   ...
   public class CmdMenu extends Sprite
   {
      ...
      private var m_mapCmdMenuList:Dictionary;
      
      private var m_lstCmd:Array;
      
      private var m_lstCmdMenuList:Array;
      ...
      {
         this.m_mapCmdMenuList = new Dictionary();
         this.m_lstCmd = new Array();
         this.m_lstCmdMenuList = new Array();
         this.m_lable = param1;
         super();
      }
