package com.QQ.angel.common
{
   ...
   public class __global
   {
      ...
      public static function escDialogData(param1:Object) : Array
      {
         ...
         {
            if((_loc5_ = _loc3_[_loc4_]).hasOwnProperty("npcID"))
            {
      ...
      public static function executeClick(param1:*, param2:Boolean = true, param3:Function = null) : void
      {
         ...
         var _loc4_:NPCCDConvert;
         if((_loc4_ = param1 as NPCCDConvert) == null)
         {
            if(!(param1 is XML))
            {
               return;
            ...
            _loc5_ = param1.@event;
            (_loc4_ = createNPCCD(_loc5_)).tranNPCClickDes(param1);
         }
         ...
         var _loc6_:Array;
         if((_loc6_ = _loc4_.logArgs) != null)
         {
            log(_loc6_[0],_loc6_[1]);
         }
         if(_loc5_ == "ACTIVE")
         {
            if((_loc7_ = _loc4_.target) != null && _loc7_.hasOwnProperty("setActiveNPC"))
            {
      ...
      public static function heroClosedExec(param1:Point, param2:int = 0, param3:CFunction = null) : void
      {
         ...
         var _loc4_:Number;
         if((_loc4_ = __roleSys.distanceToMR(param1.clone())) <= uint(param2))
         {
            param3.invoke();
            return;
         }
         var _loc5_:WalkAndThenDes;
         (_loc5_ = new WalkAndThenDes()).aim = param1;
         _loc5_.dis = param2;
      ...
      public static function getAvataPreview(param1:uint, param2:uint = 100, param3:uint = 0, param4:uint = 0) : BitmapData
      {
         ...
         var _loc6_:GotAvatarImgDes;
         (_loc6_ = new GotAvatarImgDes()).uin = param1;
      ...
      public static function objectToJsonString(param1:Object) : String
      {
         ...
         for(_loc4_ in param1)
         {
            ...
            if((_loc5_ = param1[_loc4_]) is String)
            {
      ...
      public static function ReadPtloginSign(param1:IDataInput) : String
      {
         ...
         if(_loc4_ = __global.SysAPI.getGDataAPI().getGlobalVal(Constants.CUR_SERVER_INFO) as ServerInfo)
         {
            if(_loc2_ == 10)
            {
               _loc4_.skey = _loc3_;
