package com.QQ.angel.actions.ui
{
   ...
   public class IntegratedApp extends Sprite implements IAngelApp, IScaleWindowContent, IParamsAware, IXMLScriptParamsAware
   {
      ...
      protected var _cur_cgi_root:String;
      
      public function IntegratedApp()
      {
         this._cur_cgi_root = DEFINE.CGI_ROOT;
         super();
      }
      ...
      protected function changeBody(param1:int, param2:int, param3:Function) : void
      {
         ...
         var _loc4_:ReqChangeBody;
         (_loc4_ = new ReqChangeBody(param1)).type = param2;
         var _loc5_:P_FreeRequest;
         (_loc5_ = new P_FreeRequest(196649,_loc4_,ReqChangeBody,this.onDataReceive)).send();
      }
      ...
      protected function onDataReceive(param1:ReqChangeBody) : void
      {
         ...
         var _loc4_:IResAdapter;
         (_loc4_ = this.angelSysAPI.getResSysAPI().getResAdapter(Constants.AVATAR_RES)).requestRes(_loc3_);
      }
