   ...
   public class Astar1
   {
      ...
      public function find(param1:int, param2:int, param3:int, param4:int) : Array
      {
         ...
         while(this.m_openCount > 0)
         {
            ...
            {
               _loc12_ = (_loc11_ = this.m_movementCostList[_loc6_] + (_loc13_[0] == _loc7_ || _loc13_[1] == _loc8_ ? this.COST_STRAIGHT : this.COST_DIAGONAL)) + (Math.abs(param3 - _loc13_[0]) + Math.abs(param4 - _loc13_[1])) * this.COST_STRAIGHT;
      ...
      private function getArounds(param1:int, param2:int) : Array
      {
         ...
         _loc5_ = param2;
         var _loc7_:*;
         if((_loc7_ = this.m_mapTileModel.isBlock(param1,param2,_loc4_,_loc5_) == 1) && !this.isClosed(_loc4_,_loc5_))
         {
         ...
         _loc5_ = param2 + 1;
         var _loc8_:*;
         if((_loc8_ = this.m_mapTileModel.isBlock(param1,param2,_loc4_,_loc5_) == 1) && !this.isClosed(_loc4_,_loc5_))
         {
            _loc3_.push([_loc4_,_loc5_]);
         }
         _loc4_ = param1 - 1;
         _loc5_ = param2;
         var _loc9_:*;
         if((_loc9_ = this.m_mapTileModel.isBlock(param1,param2,_loc4_,_loc5_) == 1) && !this.isClosed(_loc4_,_loc5_))
         {
            _loc3_.push([_loc4_,_loc5_]);
         }
         _loc4_ = param1;
         _loc5_ = param2 - 1;
         var _loc10_:*;
         if((_loc10_ = this.m_mapTileModel.isBlock(param1,param2,_loc4_,_loc5_) == 1) && !this.isClosed(_loc4_,_loc5_))
         {
            _loc3_.push([_loc4_,_loc5_]);
         }
         _loc4_ = param1 + 1;
         _loc5_ = param2 + 1;
         if((_loc6_ = this.m_mapTileModel.isBlock(param1,param2,_loc4_,_loc5_) == 1) && _loc7_ && _loc8_ && !this.isClosed(_loc4_,_loc5_))
         {
            _loc3_.push([_loc4_,_loc5_]);
         }
         _loc4_ = param1 - 1;
         _loc5_ = param2 + 1;
         if((_loc6_ = this.m_mapTileModel.isBlock(param1,param2,_loc4_,_loc5_) == 1) && _loc9_ && _loc8_ && !this.isClosed(_loc4_,_loc5_))
         {
            _loc3_.push([_loc4_,_loc5_]);
         }
         _loc4_ = param1 - 1;
         _loc5_ = param2 - 1;
         if((_loc6_ = this.m_mapTileModel.isBlock(param1,param2,_loc4_,_loc5_) == 1) && _loc9_ && _loc10_ && !this.isClosed(_loc4_,_loc5_))
         {
            _loc3_.push([_loc4_,_loc5_]);
         }
         _loc4_ = param1 + 1;
         _loc5_ = param2 - 1;
         if((_loc6_ = this.m_mapTileModel.isBlock(param1,param2,_loc4_,_loc5_) == 1) && _loc7_ && _loc10_ && !this.isClosed(_loc4_,_loc5_))
         {
            _loc3_.push([_loc4_,_loc5_]);
         }
         return _loc3_;
