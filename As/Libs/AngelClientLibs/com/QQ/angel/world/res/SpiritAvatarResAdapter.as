package com.QQ.angel.world.res
{
   ...
   public class SpiritAvatarResAdapter extends BaseAvatarResAdapter
   {
       
      
      protected var commURL:String;
      
      public function SpiritAvatarResAdapter()
      {
         this.commURL = DEFINE.COMM_ROOT + "res/spirit/";
         super();
         resType = Constants.SCENE_RES;
      }
