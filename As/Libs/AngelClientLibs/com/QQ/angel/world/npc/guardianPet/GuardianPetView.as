package com.QQ.angel.world.npc.guardianPet
{
   ...
   public class GuardianPetView extends BaseObjectView
   {
      ...
      public function GuardianPetView(param1:IResAdapter, param2:uint = 0, param3:uint = 0)
      {
         super();
         if(param1 == null)
         {
            throw new Error("GuardianPetView的资源请求适配器不能为NULL！");
         }
      ...
      public function setHeadTxt(param1:String) : void
      {
         ...
         if(_loc3_)
         {
            if(_loc3_.@color != undefined)
            {
               if((_loc5_ = String(_loc3_.@color).split("#")).length > 1)
               {
                  _loc4_ = uint("0x" + _loc5_[1]);
               }
               else
               {
                  _loc4_ = 16711680;
      ...
      override public function setXYLocation(param1:Number, param2:Number) : void
      {
         locXY.x = param1;
         locXY.y = param2;
         this.x = int(param1 - 55);
         this.y = int(param2 - 55);
      }
      ...
      {
         removeEventListener(MouseEvent.MOUSE_OVER,this.onViewMouseOver);
         removeEventListener(MouseEvent.MOUSE_OUT,this.onViewMouseOut);
         if(Boolean(param1) && param1 != "")
         {
            ...
            this.tipsAsset.y = -80;
            addEventListener(MouseEvent.MOUSE_OVER,this.onViewMouseOver);
            addEventListener(MouseEvent.MOUSE_OUT,this.onViewMouseOut);
         }
      }
      
      private function onViewMouseOver(param1:MouseEvent) : void
      {
         if(this.tipsAsset == null)
         {
            this.tipsAsset = new SpiritLV();
         }
         addChild(this.tipsAsset);
      }
      
      private function onViewMouseOut(param1:MouseEvent) : void
      {
