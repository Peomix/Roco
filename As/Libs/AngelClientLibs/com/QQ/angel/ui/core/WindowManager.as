package com.QQ.angel.ui.core
{
   ...
   public class WindowManager implements ICommUIManager
   {
      ...
      public function showFurnitureRewardArray(param1:Array, param2:Function = null) : void
      {
         ...
         {
            if(!((_loc6_ = param1[_loc5_]) == null || _loc6_.count <= 0))
            {
               if(_loc6_.name == null || _loc6_.name == "")
               {
                  if(!((Boolean(_loc7_ = __global.SysAPI.getGDataAPI().getDataProxy(Constants.FURNITURE_LIST_DATA).select(_loc6_.id))) && _loc7_.name != null))
                  {
      ...
      public function showRewardArray(param1:Array, param2:Function = null) : void
      {
         ...
         for(; _loc10_ < _loc4_; _loc10_++)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(!(_loc11_.hasOwnProperty("itemType") && _loc11_.itemType == 6 || _loc9_ == 7))
               {
                  if(_loc7_ <= 0)
                  {
                     continue;
               ...
               if(_loc11_.hasOwnProperty("itemType") && _loc11_.itemType == 6)
               {
                  if((_loc5_ = __global.SysAPI.getGDataAPI().getDataProxy(Constants.DAZZLE_DRESS_DATA).select(_loc6_)) != null)
                  {
                     _loc3_.items.push({
                        "num":1,
               ...
               {
                  if((_loc5_ = __global.SysAPI.getGDataAPI().getDataProxy(Constants.ITEM_DATA).select(_loc6_)) != null)
                  {
                     _loc3_.items.push({
                        "num":_loc7_,
                        "src":_loc5_.url,
                  ...
                  else if((_loc5_ = __global.SysAPI.getGDataAPI().getDataProxy(Constants.SPIRIT_DATA).select(_loc6_)) != null)
                  {
                  ...
                  else if((_loc5_ = __global.SysAPI.getGDataAPI().getDataProxy(Constants.FURNITURE_LIST_DATA).select(_loc6_)) != null)
                  {
                  ...
                  else if((_loc5_ = __global.SysAPI.getGDataAPI().getDataProxy(Constants.DRESSUP_LIST_DATA).select(_loc6_)) != null)
                  {
                  ...
                  else if((_loc5_ = __global.SysAPI.getGDataAPI().getDataProxy(Constants.SEQUIP_DES_DATA).select(_loc8_)) != null)
                  {
               ...
               else
               {
                  switch(_loc9_)
                  {
                     ...
                     case 2:
                        ...
                        continue;
                     case 3:
                        if((_loc5_ = __global.SysAPI.getGDataAPI().getDataProxy(Constants.FURNITURE_LIST_DATA).select(_loc6_)) == null)
                        {
                           break;
                        }
                        _loc14_ = _loc5_ as FurnitureDes;
                        ...
                        continue;
                     case 4:
                        if((_loc5_ = __global.SysAPI.getGDataAPI().getDataProxy(Constants.SPIRIT_DATA).select(_loc6_)) == null)
                        {
                           break;
                        }
                        _loc13_ = _loc5_ as SpiritDes;
                     ...
                     case 5:
                        ...
                        continue;
                     case 6:
                        if((_loc5_ = __global.SysAPI.getGDataAPI().getDataProxy(Constants.SEQUIP_DES_DATA).select(_loc6_)) == null)
                        {
                           break;
                        }
                        _loc15_ = _loc5_ as SpiritEquipmentDes;
      ...
      public function showManagedWin(param1:int, param2:Object = null, param3:CFunction = null) : IWindow
      {
         ...
         var _loc4_:IWindow;
         if((_loc4_ = this._winCache[param1] as IWindow) == null)
         {
            if((_loc5_ = this._winClsMap[param1] as Class) == null)
            {
               return null;
            }
         ...
         {
            (_loc6_ = _loc4_ as IManagedWin).bindHandler(param3);
      ...
      {
         var _loc5_:IWindow;
         return (_loc5_ = this.createAlert(param1,param2,param3,param4)).id;
      }
      
      public function mAlert(param1:MovieClip, param2:String = "", param3:String = "", param4:Function = null, param5:Function = null) : IWindow
      {
         var _loc6_:MAlert;
         (_loc6_ = this.createWindow(MAlert) as MAlert).init(param1,param2,param3,param4,param5);
         _loc6_.show();
         return _loc6_;
      }
      ...
      private function registerWindow(param1:Window, param2:DisplayObjectContainer = null) : void
      {
         ...
         else
         {
            ...
            _loc6_ = (_loc4_ = param2.numChildren) - 1;
            while(_loc6_ >= 0)
            {
               if((_loc5_ = param2.getChildAt(_loc6_) as IWindow) is Window && _loc5_ != param1 && !_loc5_.isModal)
               {
