package com.QQ.angel.ui.core
{
   ...
   public class ScaleWindow extends Window
   {
      ...
      protected var borderSize:Point;
      
      public function ScaleWindow(param1:DisplayObjectContainer, param2:Boolean = false)
      {
         this.contentPos = new Point(18,30);
         this.borderSize = new Point(50,49);
         super();
      ...
      override public function show() : void
      {
         ...
         if(_loc1_ != null && _loc1_.hasOwnProperty("reflash"))
         {
            _loc1_["reflash"]();
         }
      }
      ...
      override public function close() : void
      {
         ...
         {
            _loc1_ = this.swc;
            if(_loc1_ != null && _loc1_.hasOwnProperty("onIdel"))
            {
               _loc1_["onIdel"]();
            }
         }
